...
String q1 = JOptionPane.showInputDialog("What is your star sign?");
	
	if (q1.equals("Aries")) {
		JOptionPane.showMessageDialog(null, "Upside: Highly energetic, and has no problem working long hours on a single project. Often take the initiative experiencing new breakthroughs and discoveries. Aries are thorough, painstaking, and have a knack for precise records and clarity. They live hard, love hard, and play hard.\r\n" + 
				"\r\n" + 
	...
	if (q1.equals("Taurus")) {
		JOptionPane.showMessageDialog(null, "Upside: Taurus people almost always finish what they start. They are deliberate thinkers and when making decisions usually make the right one. Taurus are generally adaptable, adjusting easily to new circumstances especially if there is the reward of luxury, comfort, or sensual reward. This sign loves to laugh and spend time with family.\r\n" + 
				"\r\n" + 
				"Downside: Taurus can be stubborn and ‘bullish’ about ideas that they’ve adopted, which can also make them difficult to get along with when attempting to cooperate on a shared project. Taurus needs to be the leader and to be held in high esteem. If they are not, they refuse to work, often finding small ways to sabotage projects, relationships, or undermine authority that they deem unworthy of leadership.");
	}
	
	if (q1.equals("Gemini")) {
		JOptionPane.showMessageDialog(null, "Upside: Gemini are great conversationalists, and are charming people. Interesting to speak with, Gemini know a little bit about a lot of things. They have a great sense of humor and are generally optimistic people. Gemini often make their own fun, despising boredom.\r\n" + 
				"\r\n" + 
				"Downside: Gemini like to be the center of attention; always. When they perceive the situation to not be in their favor, they leave it. This can include relationships, careers, and friendships. Because of this need to be seen as important, Gemini will sometimes stretch the truth. When they are focused only on themselves they can be largely unsympathetic and rude. Male Gemini tend to change jobs often, and female Gemini change partners often due to boredom.");
	}
	
	if (q1.equals("Cancer")) {
		JOptionPane.showMessageDialog(null, "Upside: Cancer have an offbeat sense of humor, often finding something humorous that others don’t. They are extremely good listeners and have a heart for the problems of others. In fact, many gravitate toward this sign because they intuitively know that a Cancer will understand. When a Cancer becomes your friend you can be sure that they are truly your friend and will not consider using someone to their own benefit. Cancer tend to be dependable and reliable. They will tell you anything you want to know about them without blinking an eye as they are drawn to honesty in others as well as themselves.\r\n" + 
				"\r\n" + 
	...
	if (q1.equals("Aquarius")) {
		JOptionPane.showMessageDialog(null, "Upside: Aquarians are among the friendliest of the signs, making friends everywhere. They are often chosen among co-workers and family for special awards and honors because of their ability to network. Highly intelligent they are energetic and talented, often using their abilities to help others. Despite their extensive people skills, they often crave alone time to reflect and think about things. Meditation is recommended for this sign as it helps to maintain that sense of alone time, while at the same time a feeling of connectedness with something greater than themselves.\r\n" + 
				"\r\n" + 
	...
	if (q1.equals("Pisces")) {
		...
		JOptionPane.showMessageDialog(null, "If you don't know your star sign, go to this site: https://www.horoscopedates.com/zodiac-signs/");
	}
